...
class Departamento(models.Model):
    nombre_departamento =  models.CharField(max_length=30, verbose_name = 'Departamento')
...
class Documento(models.Model):
    tipodocumento = models.CharField(max_length=4, verbose_name = 'Tipo de documento')
...
class Colombia(models.Model):
    ...
    numerodocumento = models.CharField(max_length=15, blank=False, verbose_name = 'Numero de documento')
